...
# Panel 1: start/mode
MB.addRotary3(['P1_ROT3', 'gameMode'], TM=1, line=2, pins=[2,3])

# Panel 2: displays
MB.addRGBLED(['oxygen', 'electricity', 'takeoff', 'overspeed', 'gate1',
             'automaticPilot', 'orbit', '', 'gate2', 'alarm', 'landing', ''], start=0)
MB.addSSD(TM=1, block=0)

# Panel 3: laser
MB.addSwitch2(['P3_SW_0', 'LaserArmed'], TM=1, line=1, pin=1)
MB.addSwitch2(['P3_SW_1', 'LaserColor'], TM=1, line=1, pin=2)

# Panel 4: pilot
MB.addLED(['P4_LED', 'manual'], TM=1, line=1, pin=3)
MB.addPotentiometer(['P4_POT_0', 'roll'], AN=1)
MB.addPotentiometer(['P4_POT_1', 'yaw'], AN=2)
MB.addPotentiometer(['P4_POT_0', 'speed'], AN=0)

# Panel 5: flight mode
MB.addRotary3(['P5_SW_3POS', 'mode'], TM=1, line=1, pins=[4,5])
MB.addSwitch2(['P5_SW2', 'automaticPilot'], TM=1, line=1, pin=12)

# Panel 6: lift-off
MB.addSwitch2(['P6_SW2_1', 'phase1'], TM=1, line=1, pin=12)
MB.addSwitch2(['P6_SW2_2', 'phase2'], TM=1, line=1, pin=13)
MB.addSwitch2(['P6_SW2_3', 'phase3'], TM=1, line=1, pin=14)
